            ...
            public void onClick(View view) {
                ...
                if (moveNumber>movesToExecute.size()) {
                    ...
                    if (split.length==2) {
                        ...
                        Piece mover = chessBoard.grid[startingX][startingY].getPiece();
                        ...
                        Piece mover = chessBoard.grid[startingKingX][startingKingY].getPiece();
                        ...
                        Piece newMover = chessBoard.grid[startingRookX][startingRookY].getPiece();
